...
const AddNewArrival = ({ setIsShowing }) => {
  ...
  const postNewArrival = async (formData) => {

    try {
      setIsLoading(true)
      const result = await axios.post(`${import.meta.env.VITE_API_URL}/newArrival`, formData)
  ...
  const onSubmit = (data) => {
    ...
    postNewArrival(formData)
  };
  return (
    <div className="w-full text-center space-y-5 pt-12  bg-white   overflow-hidden sm:rounded-md  max-w-4xl mx-auto ">
      <h1 className="text-3xl">Add New Arrival </h1>
