...
const AddWomenPerfume = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      ...
      .post(`${import.meta.env.VITE_API_URL}/topRatedPerfume`, formData)
      .then((res) => {
        setIsLoading(false)
        navigate(
          '/perfumes')
    ...
    <>
      <section className="bg-white ">
        <div className="max-w-4xl px-4 py-8 mx-auto lg:py-16">
          <h2 className="mb-4 text-xl font-bold text-gray-900 ">Add Top Rated Perfume</h2>
          <Toaster />
          <Select
...
export default AddWomenPerfume;
